...
public class PropType extends Kind {
  ...
  public static boolean isWall(Element e) {
    if (e == null || ! e.isProp()) return false;
  ...
  public boolean isWall() {
    return subtype() == SUBTYPE_WALLING && (wide() == 0 || high() == 0);
  }
  
  
  public boolean isFloor() {
    if (blockLevel() != BLOCK_NONE) return false;
    if (subtype() != SUBTYPE_WALLING) return false;
